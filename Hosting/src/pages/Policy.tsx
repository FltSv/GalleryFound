export const Policy = () => (
  <div>
    ...
    <p>
      ...
      so that they will be able to take the necessary actions. You must also be
      at least 16 years of age to consent to the processing of your personally
      identifiable information in your country (in some countries we may allow
    ...
    <p>
      ...
      via Github at https://github.com/FltSv/GalleryFound/discussions/108.
    </p>
    <hr />
    <p>
    ...
    <p>
      ...
      created by suna (hereby referred to as &quot;Service Provider&quot;) as an
      Open Source service.
    </p>
    <br />
    <p>
